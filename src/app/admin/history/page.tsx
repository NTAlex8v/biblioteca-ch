...
import { History, FileText, User, Folder, Shapes, Tag as TagIcon } from 'lucide-react';
    ...
    <div className="container mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
            ...
            <p className="text-muted-foreground">Actividad del sistema en los últimos 7 días.</p>
        </div>
      </div>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {isLoadingLogs ? 'Cargando historial...' : `Se encontraron ${logs?.length || 0} registros.`}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
              ...
              {isLoadingLogs ? (
                ...
                <TableRow>
                  <TableCell colSpan={5} className="h-24 text-center">
                    No se encontraron registros de cambios en los últimos 7 días.
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
