...
export default function CategoryClientPage({ category }: CategoryClientPageProps) {
  ...
  // Query for sub-folders within this category
       ...
       {isLoading ? (
            ...
            (!folders || folders.length === 0) && (
              <div className="text-center py-16 border-2 border-dashed rounded-lg">
                  <h3 className="text-xl font-semibold text-muted-foreground">Esta categoría está vacía</h3>
                  <p className="text-muted-foreground mt-2">Puedes ser el primero en añadir una carpeta o un documento.</p>
              </div>
            )
        )}
    </div>
